...
#define UNMATCHEDRESPONSES                      126
#define ALIASFAILURERESPONSESCNAME              128
#define ALIASFAILURERESPONSESCNAME_S            130
#define ALIASFAILURERESPONSESNONAME             132
#define ALIASFAILURERESPONSESNONAME_S           134
#define ALIASFAILURERESPONSESEMPTYAUTH          136
#define ALIASFAILURERESPONSESEMPTYAUTH_S        138
#define ALIASFAILURERESPONSESSRVFAIL            140
#define ALIASFAILURERESPONSESSRVFAIL_S          142
#define TOTALREMOTEINFLIGHTQUERIES              144
#define DROPPEDQUERYPOLICY                      146
#define DROPPEDQUERYPOLICY_S                    148
#define DROPPEDQUERYRRL                         150
#define DROPPEDQUERYRRL_S                       152
#define DROPPEDQUERYEXTERNAL                    154
#define DROPPEDQUERYEXTERNAL_S                  156
#define DROPPEDQUERYSEND                        158
#define DROPPEDQUERYSEND_S                      160
#define DROPPEDQUERYBADSOCKET                   162
#define DROPPEDQUERYBADSOCKET_S                 164
#define DROPPEDQUERYTOTAL                       166
#define DROPPEDQUERYTOTAL_S                     168
#define RESPONSESSUPPRESSED                     170
#define RESPONSESSUPPRESSED_S                   172
#define TOTALTHROTTLEDQUERIES                   174
#define TOTALTHROTTLEDQUERIES_S                 176
...
extern volatile unsigned long * pcUnmatchedResponses;
extern volatile unsigned long * pcAliasFailureResponsesCName;
extern volatile unsigned long * pcAliasFailureResponsesNoName;
extern volatile unsigned long * pcAliasFailureResponsesEmptyAuth;
extern volatile unsigned long * pcAliasFailureResponsesSrvFail;
extern volatile unsigned long * pcTotalRemoteInFlightQueries;
extern volatile unsigned long * pcDroppedQueryPolicy;
extern volatile unsigned long * pcDroppedQueryRRL;
extern volatile unsigned long * pcDroppedQueryExternal;
extern volatile unsigned long * pcDroppedQuerySend;
extern volatile unsigned long * pcDroppedQueryBadSocket;
extern volatile unsigned long * pcDroppedQueryTotal;
extern volatile unsigned long * pcResponsesSuppressed;
extern volatile unsigned long * pcTotalThrottledQueries;

#define PERF_INC(p)         InterlockedIncrement( p )
#define PERF_DEC(p)         InterlockedDecrement( p )

#if 1
#define PERF_ADD(p, c)      InterlockedExchangeAdd( p, c )
#define PERF_SUB(p, c)      InterlockedExchangeAdd( p, -( LONG ) ( c ) )
#else
